...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/admin-main.css" type="text/css">
...
//차트  --------------------------------------------
$(function(){
	let url = "${pageContext.request.contextPath}/admin/main/line1";
...
<div class="body-title">
	<div class="col" style="display: flex; justify-content:space-between;">
		<div class="perform__title" > 
			<span style="font-family: 'line_font_b';">Data analysis</span>
		</div>
		<div class="pb-1">
			<button type="button" class="print_btn shadow-sm" onclick="location.href='${pageContext.request.contextPath}/admin/mypage/main';"><i class="fa-solid fa-user"></i>&nbsp;&nbsp; 관리자 정보 바로가기 </button>
...
<div class="row">
	...
	<div class="sales__goals__area__btn  shadow-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">매출 목표 변경</div>
</div>
...
<div class="perform__title2" style="display: flex; justify-content:space-between;"> 
	<span style="font-family: 'line_font_b';">매출 통계 및 유료 구독자 비율<button class="more__sales" onclick="location.href='${pageContext.request.contextPath}/admin/perform/main_content';">+ 더보기</button></span>
</div>
