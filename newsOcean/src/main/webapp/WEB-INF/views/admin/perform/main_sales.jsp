...
<div class="body-title">
	<div class="col" style="display: flex; justify-content:space-between;">
		...
		<div class="pb-1">
			<button type="button" class="print_btn shadow-sm" onclick="location.href='${pageContext.request.contextPath}/admin/perform/excel_sales';"><i class="fa-solid fa-file-excel"></i>&nbsp;&nbsp; EXCEL 파일 다운로드 </button>
