...
<form name="mypageForm" method="post">
	...
	<button type="button" class="btn-update-1 btn shadow" style="margin-left: 104px;" onclick="sendOk();">수정하기</button>
	<button type="button" class="btn-update-1 btn shadow" onclick="sendCancel();">수정취소</button>
 </form>